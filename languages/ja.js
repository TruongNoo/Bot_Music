const language = {
  ...
  msg32:
    "完全無料かつ高度なインターフェイスで、あなたのdiscordサーバーで楽曲を聴くときが来たのです。多くのプラットフォームでの音楽再生をサポートする音楽ボットで、あなたのサーバーを特別な雰囲気にします。あなただけの音楽ボットを作りましょう！https://github.com/TruongNoo/Cei_Music.git",
  msg33: "Botのコマンド",
